...
const InsuranceClaimPage = (props) => {
  ...
  useEffect(() => {
    ...
    axios
      .get(`http://localhost:4000/api/get-policies/${employeeid}`)
      .then((response) => {
  ...
  function submitInsuranceClaim(values) {
    ...
    // axios
    //   .post(`http://localhost:4000/api/post-claim`, {
    //     email: values.email,
